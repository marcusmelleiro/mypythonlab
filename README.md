#CRIANDO UM SISTEMA BANCÁRIO SIMPLES COM PYTHON COM O BJETIVO DE INCIAR OS ESTUDOS NA LINGUAGEM

- OBJETICO GERAL: Criar um sistema bancário com as operações: sacar, depositar e visualizar extrato.
...
- DEPOSITO: Deve ser possível depositar valores positivos para a minha conta bancária. A v1 do projeto trabalha apenas com 1 usuário, dessa forma não precisamos nos preocupar em identificar qual é o número da agência e conta bancária. Todos os depósitos devem ser armazenados em uma variável e exibidos na operação de extrato.
